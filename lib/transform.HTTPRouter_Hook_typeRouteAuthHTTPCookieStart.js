module.exports = function(db, transform, input, render, callback){
	...
	var q = input.db.match(subject, 'http://magnode.org/auth');
	...
	var resourceTypes = db.match(auth, "http://www.w3.org/1999/02/22-rdf-syntax-ns#type").map(function(v){return v.object});
...
module.exports.about =
	{ a: 'view:Transform'
	, 'view:domain': {$list:['type:RouteAuthHTTPCookieStart']}
