...
module.exports.parseUriVariants = function parseUriVariants(uri){
	...
	variantSubset.applyTransforms = (Array.isArray(query.apply)&&query.apply) || (typeof query.apply=="string"&&[query.apply]) || [];
	...
	variantSubset.useTransformTypes = (Array.isArray(query.with)&&query.with) || (typeof query.with=="string"&&[query.with]) || [];
	// Provide an ?edit shortcut to the appropriate transformType
	variantSubset.editable = typeof query.edit=="string";
	variantSubset.createNew = typeof query.new=="string";
	variantSubset.showDelete = typeof query.delete=="string";
	...
	variant.type = urlArgs.query.view || urlArgs.query.edit;

	return variantSubset;
}
