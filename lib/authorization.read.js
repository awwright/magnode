...
module.exports.prototype.test = function readTest(user, actions, resources, callback){
	...
	if(actions.some(function(v){ return validActions.indexOf(v)<0; })) return void callback(false, 'read:action\u2209permission');
	...
	return void callback(false, 'read:permission\u2209targetType');
}
