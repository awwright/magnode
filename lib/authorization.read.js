...
module.exports = function(actions, types){
...
module.exports.prototype.test = function(user, actions, resources, callback){
	...
	if(actions.some(function(v){ return validActions.indexOf(v)<0; })) return callback(false);
	...
	if(validTypes.some(function(v){ return Object.prototype.hasOwnProperty.call(resources,v); })) return callback(true);
