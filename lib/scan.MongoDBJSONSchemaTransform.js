...
module.exports.scanMongoCollection = function(db, dbSchema, render, cb){
	...
	function routeRequest(resource, found){
		...
		function foundRecord(schema, types, record){
			...
			// FIXME produce a custom menu here
			ret['http://magnode.org/HTMLBodyBlock_ResourceMenu'] = '<ul><li><a href="?">View</a></li><li><a href="?edit">Edit</a></li><li><a href="?delete">Delete</a></li></ul>';
			...
			ret.variant = queryVariant(resource, requiredTypeMap);
			found(null, ret);
		}
	}
