	...
	*/
	...
	function runCache(){
		...
		if(resources.indexer){
			if(request.method=='PUT'){
				res = resources.indexer['MongoDB_Cache_Put'].emit(db, transform, resources, render, parsedData, schema, links);
	...
	function haveResponse(err){
		...
		if(resources.indexer){
			...
			if(request.method=='PUT'){
				resources.indexer['MongoDB_Index_Put'].emit(db, transform, resources, render, parsedData, schema, links);
			}else if(request.method=='DELETE'){
