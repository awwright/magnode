...
function handleRequest(request, response, route, staticresources, view){
	...
	function haveResource(dbresult){
		...
		switch(request.headers['content-type']){
			case 'application/x-www-form-urlencoded': result['http://magnode.org/HTTPRequest-form-urlencoded']=request; break;
			case 'multipart/form-data': result['http://magnode.org/HTTPRequest-multipart-form-data']=request; break;
		}
