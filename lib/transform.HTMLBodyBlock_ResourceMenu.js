...
module.exports = function(db, transform, input, render, callback){
	...
	function nextItem(i){
		...
		userAuth._auth = input['http://magnode.org/UserSession'] && input['http://magnode.org/UserSession'].formToken;
...
module.exports.about =
	...
	, 'view:domain': {$list:['type:UserSession']}
	, 'view:range': ['type:HTMLBodyBlock_ResourceMenu', 'view:render'.l()]
	};
