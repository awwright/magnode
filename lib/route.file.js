...
// TODO: Consolidate some of the various config options into a single config object
// TODO: Maybe allow a config option to set additional types of the resources produced (typically for authorization purposes)
	...
	function routeResource(resource, callback){
		...
		function statNextFile(i){
			...
			fs.readFile(srcFile, function(err, contents){
				if(err || !contents) return void statNextFile(i+1);
