...
module.exports.prototype = {
	...
	evaluateQuery: function(queryGraph, querySubject, objectBindings){
		...
		function varName(v){return v.substr&&v.substr(0,sp_.length)==sp_ && v.replace(sp_, "")};
...
module.exports.generate =
	{ "@id":"http://magnode.org/transform/DBRDFMemory_New"
	, domain:"http://magnode.org/DBRDFMemory"
	, range:["http://magnode.org/DBRDFMemory_Instance","http://magnode.org/DBRDF_Instance"]
	, postConstructType:"http://magnode.org/transform/DBRDFMemory_Hook"
	, arguments: [{type:"array",value:{type:"http://magnode.org/DBRDF_Instance",input:{subject:"$subject",predicate:"http://magnode.org/import",object:"$result"}}}]
	, construct: function(importSources){ var db = new module.exports; importSources.forEach(function(src){ src.filter().forEach(function(v){db.add(v);}); }); return db; }
	};
