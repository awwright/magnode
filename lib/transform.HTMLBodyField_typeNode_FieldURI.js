/*
Transform:HTMLBodyField_typeNode_FieldURI
	a view:Transform, view:ModuleTransform, view:ViewTransform;
	view:module "magnode/transform.HTMLBodyField_typeNode_FieldURI" ;
...
module.exports = function HTMLBodyField_typeNode_FieldURI(db, transform, input, render, callback){
	...
	var out = '<input name="value.'+escapeHTMLAttr(name)+'" value="'+escapeHTMLAttr(value)+'" class="field-uri"/><input type="hidden" name="format.'+escapeHTMLAttr(name)+'" value="string"/>';
	var ret = {};
