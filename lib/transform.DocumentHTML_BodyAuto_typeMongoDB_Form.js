...
function renderField(name, type, value){
	switch(type.type){
		...
		case 'array':
		case 'json': return '<textarea name="value.'+htmlEscape(name)+'">'+htmlEscape(JSON.stringify(value,null,"\t"))+'</textarea><input type="hidden" name="type.'+htmlEscape(name)+'" value="json"/>';
