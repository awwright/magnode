...
*/
// view:domain type:Node_FieldURI .
...
module.exports = function DocumentHTML_BodyField_typeNode_FieldURI(db, transform, input, render, callback){
	...
	var out = '<input name="value.'+htmlEscape(name)+'" value="'+htmlEscape(value)+'" class="field-uri"/><input type="hidden" name="format.'+htmlEscape(name)+'" value="string"/>';
	var ret = {};
