...
Render.prototype.resolve = function resolve(target, input, useTransformTypes, parentTransforms, depth){
	var db = this.db;
...
Render.prototype.applyTransform = function applyTransform(transform, input, callback){
	...
	function transformResult(err, v){
		...
		else if(!v){ throw new Error('Expected error argument if no return value provided'); }
