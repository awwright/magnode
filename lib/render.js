		...
		for(var m=0; m<sList.length; m++){
			...
			for(var j=0;j<transforms.length;j++){
				...
				for(var a=0; a<matches.length; a++){
					...
					for(var f in solution.output) sc.output[f]=null;
					for(var k=0;k<transformDomain.length;k++) sc.input[transformDomain[k]]=null;
					for(var k=0;k<transformRange.length;k++) sc.output[transformRange[k]]=null;
