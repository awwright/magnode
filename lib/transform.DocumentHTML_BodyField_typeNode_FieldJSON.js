/*
Transform:DocumentHTML_BodyField_typeNode_FieldJSON
	a view:Transform, view:ModuleTransform, view:ViewTransform;
	view:module "magnode/transform.DocumentHTML_BodyField_typeNode_FieldJSON" ;
...
module.exports = function DocumentHTML_BodyField_typeNode_FieldJSON(db, transform, input, render, callback){
	...
	var out = '<textarea name="value.'+escapeHTML(name)+'" class="field-json">'+escapeHTML(JSON.stringify(value,null,"\t"))+'</textarea><input type="hidden" name="format.'+escapeHTML(name)+'" value="json"/>';
	var ret = {};
