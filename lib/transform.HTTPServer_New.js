...
module.exports = function(db, transform, input, render, callback){
	...
	var routerResource = input.db.match(subject,'http://magnode.org/router').map(function(v){return v.object});
	if(!routerResource[0]){
	...
	var listenPort = 8080;
	var q = input.db.match(subject,'http://magnode.org/listen').map(function(v){return v.object});
	if(q[0]){
...
module.exports.about =
	{ a: 'view:Transform'
	, 'view:domain': {$list:['type:HTTPServer']}
