...
module.exports = function(db, transform, resources, render, callback){
	var range = db.match(transform,"http://magnode.org/view/range").map(function(v){return v.object.toString();});
	...
	function createRequest(){
		...
		inputs.request = {url:resource, method:fieldData[':method'], headers:headers};
		...
		inputs.variant = {params:{}, resource:resources.variant.resource}; // FIXME shouldn't this be just resource:resource ?
