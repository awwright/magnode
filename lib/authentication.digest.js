...
require('rdf').context.setMapping("sp", "http://spinrdf.org/sp#");
var digestQuery = sparqlParser.parse("SELECT * {?user foaf:accountName ?username; <http://magnode.org/auth/htdigest#password_digest_realm> ?realm ; <http://magnode.org/auth/htdigest#password_digest_md5> ?password. }").ref("_:query").graphify();
