...
var digestQueryGraph = rdf.parse(digestQuery, "_:query").graphify();
...
module.exports.authenticateCredential = function(db, credential, callback){
	...
	var v = db.evaluateQuery(digestQueryGraph, "_:query", {username:credential.username.l(), realm:credential.realm.l()});
...
module.exports.generate =
	{ "@id":"http://magnode.org/transform/AuthPasswordDigest_New"
	, domain:"http://magnode.org/AuthPasswordDigest"
	, range:["http://magnode.org/AuthPasswordDigest_Instance","http://magnode.org/AuthPassword_Instance"]
	, arguments:
		[ {type:"http://magnode.org/DBHtdigest_Instance", inputs:[{subject:"$subject",predicate:"http://magnode.org/db",object:"$result"}]}
		, {type:"literal", value:{subject:"$subject",predicate:"http://magnode.org/realm",object:"$result"}, default:"nyan"}
		]
	, construct: function(DBHtdigest, realm){ return new module.exports(DBHtdigest, realm); }
	};
