...
module.exports = function(db, transform, input, render, callback){
	...
	var query = input['http://magnode.org/MongoDB_List'];
	var schema = input['http://magnode.org/MongoDBJSONSchema'];
	...
	var filter = query.query&&query.query.filter || {type:subject};
	...
	if(query.query&&query.query.sort){
		var sortOrder = {};
		var keys = (query.query.sort instanceof Array)?query.query.sort:[query.query.sort];
