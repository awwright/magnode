...
module.exports = function(route, db, authz){
	...
	renders["http://magnode.org/view/ModuleTransform"] = function(transform, input, callback){
		var module = db.filter({subject:transform,predicate:"http://magnode.org/view/ModuleTransform/module"});
	...
	route.push(function(v){
		...
		return null;
	}, function(request, response, subject, callback){
