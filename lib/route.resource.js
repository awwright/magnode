...
module.exports.create = function(testResource){ return function(route, resources, auth, authz, view, root){
	var prefix = root || "";

	var resourceKeys = Object.keys(resources);

	var hook = function(request, cb){
		...
		var data="";
		request.on("data", function(segment){ input.requestDataBuffer += segment; });
