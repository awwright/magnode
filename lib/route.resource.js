...
module.exports = function(route, db, authz, root){
	var prefix = root || "";
	...
	renders["http://magnode.org/view/Jade"] = function(transform, input, callback){
		(require('magnode/transform.Jade'))(transform, input, callback);
	}
