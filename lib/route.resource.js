...
module.exports = function(route, sources, auth, authz, view, root){
	var prefix = root || "";
	...
	var hook = function(request, response, resource, callback){
		...
		for(var n in resources) input[n]=sources[n];
