/*
Transform:HTTPRouter_Hook_typeRouteAboutRoutes
	a view:ModuleTransform ;
	view:module "magnode/transform.HTTPRouter_Hook_typeRouteAboutRoutes" ;
	view:domain type:RouteAboutRoutes ;
	view:range type:HTTPRouter_Hook .
*/
module.exports = function(db, transform, input, render, callback){
	var subject = input['http://magnode.org/RouteAboutRoutes'];
	...
	render.render('http://magnode.org/HTTPRouter_Instance', resources, [], function(r){
		...
		(require("magnode/route.routes"))(r['http://magnode.org/HTTPRouter_Instance']);
		callback({"http://magnode.org/HTTPRouter_Hook":[]});
	});
}
module.exports.URI = "http://magnode.org/transform/HTTPRouter_Hook_typeRouteAboutRoutes";
