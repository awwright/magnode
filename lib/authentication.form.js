...
module.exports.prototype.routeForm = function(router, resources, render, path){
	...
	router.push(path, function(request, response){
		...
		var arguments = {};
		for(var n in resources) arguments[n] = resources[n];
		arguments.request = request;
		arguments.response = response;
		arguments["http://magnode.org/DocumentHTML_Body"] = contents;
		arguments["http://magnode.org/DocumentHTML_BodyLoginform"] = contents;
