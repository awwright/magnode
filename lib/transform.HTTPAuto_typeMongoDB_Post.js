...
module.exports = function(db, transform, input, render, callback){
	...
	function haveRenderedForm(err, resources){
		...
		if(!contentTypeProfile) return void haveResponse(new Error('No JSON profile provided'));
	...
	function haveSchema(err, typeDoc){
		...
		function writeInstance(instance, schema, options, ctx){
			...
			var collection = (list.query&&list.query.mongoCollection) || input['db-mongodb-nodes'];
