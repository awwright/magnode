/*
Transform:HTTPRouter_Hook_typeFormLoginRender
	a view:ModuleTransform ;
	view:module "magnode/transform.HTTPRouter_Hook_typeFormLoginRender" ;
	view:domain type:FormLoginRender ;
...
module.exports = function(db, transform, input, render, callback){
	...
	var q = input.db.filter({subject:subject, predicate:'http://magnode.org/path'});
	...
	var end = function(){
		...
		targets['http://magnode.org/AuthHTTPForm_Instance'].routeForm(targets['http://magnode.org/HTTPRouter_Instance'], targets['http://magnode.org/Render_Instance'], path);
