	...
	while(value && parts[0]){
		...
		if(value instanceof Date){
			switch(parts[0]){
				...
				case 'Um': return ('00'+value.getUTCMonth()).substr(-2);
				case 'm': return ('00'+value.getMonth()).substr(-2);
				case 'Ud': return ('00'+value.getUTCDay()).substr(-2);
				case 'd': return ('00'+value.getDay()).substr(-2);
